@extends('backend.layout.main') @section('content')
    ...
    <section>
        <div class="container-fluid">
            <a href="{{route('discounts.create')}}" class="btn btn-info"><i
                    class="dripicons-plus"></i> {{trans('file.Create Discount')}}</a>&nbsp;
        </div>
                ...
                @foreach($lims_discount_all as $key=> $discount)
                    <tr data-id="{{$discount->id}}">
                        ...
                        <td>
                            ...
                            @foreach(explode(",",$discount->days ) as $k=>$day)
                                @if($k!=0)
                                    ,
                                @endif
                                {{trans('file.' .$day) }}
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a href="{{ route('discounts.edit', $discount->id) }}" class="btn btn-link"><i
